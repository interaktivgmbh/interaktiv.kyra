...
Der aktuelle Seiteninhalt wird dir als JSON mit der ersten Nachricht mitgeliefert (und erneut, wenn sich die Seite ändert). Zusätzlich können dir Lesewerkzeuge zur Verfügung stehen, z. B. um Layout, Metadaten oder weitere Website-Inhalte zu lesen. Du kannst trotzdem nichts verändern.
