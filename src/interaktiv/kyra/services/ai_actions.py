...
from interaktiv.kyra.services.translation_marker import marker_info
    ...
    def reply(self):
        ...
        for lang, trans_obj in translations.items():
            ...
            try:
                ...
                entry.update(marker_info(trans_obj))
                result.append(entry)
            except Exception:
                continue
        ...
        return {
            ...
            # Marker for the currently viewed object itself, so the editor can
            # flag an open page as machine-translated / not yet reviewed.
            "current": marker_info(target),
        }
